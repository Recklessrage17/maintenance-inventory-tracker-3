-- Maintenance Inventory Tracker 3.0 initial SQLite schema.
-- Synced from database/migrations/001_initial_schema.sql for Tauri SQL plugin use.
-- The root migration keeps its transaction wrapper; this copy omits BEGIN/COMMIT
-- because Tauri SQL plugin migrations are already run inside a transaction.
...
VALUES
  ...
  ('app_data_mode', 'sqlite-live-json-backup', '{"sqlite":"live app data","json":"backup export import restore","csv":"inventory import"}');
